...
class KatjushaTab extends HTMLElement{
    ...
    html(){
        return `<ul id="tab"></ul><style>${css.tab}</style>`
    }
...
class KatjushaStatus extends HTMLElement{
    ...
    html(){
        return `<slot></slot><style>${css.status}</style>`
    }
...
class KatjushaContext extends HTMLElement{
    ...
    html(){
        return `<ul id="context" class="menu"></ul><style>${css.context}</style>`
    }
...
class KatjushaPopup extends HTMLElement{
    ...
    html(){
        return `<div id="popup"></div><style>${css.popup}</style>`
    }
